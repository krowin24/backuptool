namespace ConoHaNet.Providers
{
    ...
    public partial interface IComputeProvider
    {
        ...
        */
        ...
        bool ResizeServer(string serverId, string flavor, DiskConfiguration diskConfig = null, string region = null, CloudIdentity identity = null);
        ...
        ServerIps ListServerIps(string serverId, string region = null, CloudIdentity identity = null);
    }
}
