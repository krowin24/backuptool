namespace ConoHaNet.Providers
{
    ...
    public interface INetworksProvider
    {
        ...
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.CidrFormatException">If <paramref name="cidr"/> is not in the correct format.</exception>
        /// <exception cref="NotSupportedException">
        /// If the provider does not support the given <paramref name="identity"/> type.
        /// <para>-or-</para>
        /// <para>The specified <paramref name="region"/> is not supported.</para>
        ...
        /// <returns></returns>
        bool AssociateHealthMonitor(string monitorId, string poolId, string region = null, CloudIdentity identity = null);

        /// <summary>
        /// this is not supported by design.
        /// </summary>
        IEnumerable<PortBlock> GetPortBlocks(string tenantId, string portId = null, string serverId = null, string region = null, CloudIdentity identity = null);

        /// <summary>
        /// this is not supported by design.
        /// </summary>
        IEnumerable<PortBlock> SetPortBlocks(string portId, int bandWidthIn, int bandWidthOut, Dictionary<int, string> dictPortProtocol, string region = null, CloudIdentity identity = null);
