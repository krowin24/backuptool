namespace ConoHaNet.Providers
{
    ...
    public interface IIdentityProvider
    {
        ...
        /// <exception cref="net.openstack.Core.Exceptions.Response.ResponseException">If the authentication request failed.</exception>
        ...
        /// </summary>
        UserAccess GetInternalUserAccess(CloudIdentity identity = null, bool forceCacheRefresh = false);
        ...
        /// <returns></returns>
        IEnumerable<User> ListTenantUsers(string tenantId, CloudIdentity identity = null);
    }
}
