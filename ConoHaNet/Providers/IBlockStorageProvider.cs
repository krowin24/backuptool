using ConoHaNet.Exceptions;
using ConoHaNet.Objects;
using ConoHaNet.Objects.BlockStorage;
using ConoHaNet.Objects.Volumes;
using System;
...
namespace ConoHaNet.Providers
{
    ...
    public interface IBlockStorageProvider
    {
        ...
        /// <exception cref="net.openstack.Providers.Rackspace.Exceptions.InvalidVolumeSizeException">If <paramref name="size"/> is not valid for this provider.</exception>
        ...
        Volume CreateVolume(int size, string sourceVolumeId = null, string Description = null, string Name = null, string snapshotId = null, string volumeType = null, string imageRef = null, string region = null, CloudIdentity identity = null);
        ...
        /// <para>If <paramref name="region"/> is <see langword="null"/> and no default region is available for the provider.</para>
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.VolumeEnteredErrorStateException">If the method returned due to the volume entering one of the <paramref name="errorStates"/>.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.Response.ResponseException">If the REST API request failed.</exception>
        ...
        /// <returns></returns>
        VolumeUploadImage CreateGlanceImageFromVolume(string volumeId = null, string imageName = null, string diskFormat = null, string containerFormat = null, string region = null, CloudIdentity identity = null);
