namespace ConoHaNet.Objects.Servers
{
    ...
    public class Server : SimpleServer
    {
        ...
        public Metadata GetMetadata()
        {
            ...
            return this.ExtensionData["metadata"] != null ? this.ExtensionData["metadata"].ToObject<Metadata>() : null;
        }
        ...
        //public IEnumerable<string> GetServerGlobalIps()
        //{
        //    var ports = Provider.ListInterfaceAttachments(Id, Region);
        //    List<string> ips = new List<string>();
        //    foreach (var port in ports)
        //        foreach (var ip in port.FixedIPs)
        //        {
        //            if (ip.IpAddress.Contains(".")
        //                && !ip.IpAddress.StartsWith("10.")
        //                && !ip.IpAddress.StartsWith("172.")
        //                && !ip.IpAddress.StartsWith("192.168."))
