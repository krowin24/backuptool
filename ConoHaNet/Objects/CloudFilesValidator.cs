namespace ConoHaNet.Objects
{
    ...
    {
        /// <summary>
        /// A default instance of <see cref="net.openstack.Providers.Rackspace.Validators.CloudBlockStorageValidator"/>.
        /// </summary>
        private static readonly CloudFilesValidator _default = new CloudFilesValidator();

        /// <summary>
        /// Gets a default instance of <see cref="net.openstack.Providers.Rackspace.Validators.CloudBlockStorageValidator"/>.
        /// </summary>
